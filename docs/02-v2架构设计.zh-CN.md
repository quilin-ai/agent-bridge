...
> **与 v1 的关系**：以下部分能力已在 [v1 路线图](archive/历史归档.md) 中通过 prompt contract 提供了单桥轻量版。v2 的目标不是重做这些能力，而是将它们提升到多 agent、room-aware、协议级的正式基础设施。
...
- 详见 [v1 路线图 §5 v1.3](archive/历史归档.md)
